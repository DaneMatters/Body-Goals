...
function badgeAchievementDetail(id){
  ...
  if(id==='streak7'||id==='streak30'){
    const n=scheduleStreak();
    return {lines:[`<div class="pr-line">${n}-day streak, ending today</div>`],workoutId:null};
  }
  if(id==='comeback'){
  ...
  if(id==='fullhouse'){
    return {lines:[`<div class="pr-line">Every scheduled item completed today</div>`],workoutId:null};
  }
