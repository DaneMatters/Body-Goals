...
let ui={page:lastPage(),historyFilter:'all',session:state.activeWorkout||null,restEnds:0,restTimer:null,modal:null,editingProgram:false,editingFavorites:false,historyDate:'',volumeRange:'3m',e1rmExercise:'',e1rmRange:'6m',expandedSets:new Set(),progressTab:'overview',workoutsDay:null};
let homeTimer=null;
